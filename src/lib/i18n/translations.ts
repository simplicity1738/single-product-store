...
export const translations = {
  sv: {
    ...
    bundle: {
      ...
      priceCurrentSv: "1 000 kr",
      priceOriginalSv: "1 500 kr",
      priceCurrentEn: "1 000 kr",
      priceOriginalEn: "1 500 kr",
      breakdownSv: "Blir 200 kr per flaska — dokumentation ingår.",
      breakdownEn: "Works out to 200 kr per vial — documentation included.",
      cta: "Lägg till paketet i varukorgen",
      disclaimer: "Skickas samma dag · För forskningsändamål",
      imageAlt: "SimpliCity presentationsset med förseglade substanser",
    },
    cart: {
      title: "Din varukorg",
  ...
  en: {
    ...
    bundle: {
      eyebrow: "Exclusive package offer",
      title: "Every compound. One sealed set.",
      subtitle:
        "All five SimpliCity compounds in an exclusive presentation case, with purity guaranteed for every vial.",
      priceCurrentSv: "1 000 kr",
      priceOriginalSv: "1 500 kr",
      priceCurrentEn: "1 000 kr",
      priceOriginalEn: "1 500 kr",
      ...
      disclaimer: "Ships same-day · For research use only",
      imageAlt: "SimpliCity presentation set with sealed compounds",
    },
    cart: {
      title: "Your cart",
