...
export const translations = {
  sv: {
    ...
    success: {
      ...
      subtitle: "Din beställning har mottagits och förbereds för leverans.",
      receipt: "Kvitto",
      justNow: "Just nu",
      customer: "Kund",
      ...
      emailConfirm: "En bekräftelse skickas till",
      delivery: "Beräknad leverans: 2–4 arbetsdagar",
  ...
  en: {
    ...
    success: {
      ...
      subtitle: "Your order has been received and is being prepared for shipment.",
      receipt: "Receipt",
      justNow: "Just now",
      customer: "Customer",
      ...
      delivery: "Expected delivery: 2–4 business days",
