...
export const translations = {
  sv: {
    ...
    calculator: {
      ...
      subtitle:
        "Beräkna exakt hur många enheter du ska dra upp — ange total mängd, BAC-vatten och önskad dos.",
  ...
  en: {
    ...
    calculator: {
      ...
      subtitle:
        "Calculate exactly how many units to draw — enter total amount, BAC water, and desired dose.",
